const work = {
  items: [
    {
      jobTitle: "Full-Stack Developer at F3M",
      jobDescription:
        "Working with .NET and React to implement features on F3M health projects.",
      jobTools:
        "react | javascript | typescript | react router | hooks | redux | .net mvc | .net entity framework",
      startDate: "dec 2023",
      endDate: undefined,
    },
    {
      ...
      jobDescription:
        "Worked with ReactJS (TS and JS) to implement features on Useflow projects and develop MVPs.",
      jobTools:
        "react | javascript | typescript | react router | hooks | redux | styled components",
      startDate: "jun 2023",
      endDate: "dec 2023",
    },
    {
      ...
      jobDescription:
        "Worked with ReactJS (TS and JS) to implement user interfaces on Useflow projects and learnt Flutter to implement an MVP mobile app.",
      jobTools:
        "react | javascript | typescript | react router | hooks | redux | styled components | flutter",
      startDate: "feb 2023",
      endDate: "jun 2023",
    },
    {
      ...
      jobDescription:
        "Coded a semi-humanized robot called Pepper with Python. Erasmus internship.",
      jobTools: "python",
      startDate: "jun 2019",
      endDate: "jul 2019",
    },
